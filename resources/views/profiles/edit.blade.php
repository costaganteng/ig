                ...
                <div class="card-body">
                    <form method="POST" action="/profile/{{ $user->username }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="image" class="col-md-4 col-form-label text-md-right"><strong>Ubah Foto Profilo</strong></label>

                            <div class="col-md-6 ">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('image') is-invalid @enderror" id="image" name="image">
                                    <label class="custom-file-label" for="image">{{ old('image') ?? "Upload Foto..." }}</label>
